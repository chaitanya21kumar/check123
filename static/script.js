...
document.getElementById('typing-test-tab').addEventListener('click', function() {
    ...
    document.getElementById('typing-test-section').style.display = 'block';
});

// Keep the existing handlers for other tabs
document.getElementById('audio-processing-tab').addEventListener('click', function() {
    ...
    document.getElementById('speech-to-text-section').style.display = 'none';
    document.getElementById('typing-test-section').style.display = 'none';
});
